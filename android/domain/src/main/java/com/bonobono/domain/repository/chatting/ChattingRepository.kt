...
interface ChattingRepository {
    ...
    // websocket 연결
    suspend fun connectWebSocket(url: String) : NetworkResult<Unit>

    // websocket 끊기
    suspend fun disconnectWebSocket() : NetworkResult<Unit>

    // websocket 소통
    suspend fun sendMessage(message : String) : NetworkResult<Unit>
}