...
class SignUpViewModel : ViewModel() {
    ...
    fun updatePasswordCheck(input: String) {
        ...
        if(password != "" && passwordCheck != "") {
            ...
            if(password == passwordCheck) checkPwdValid = true
        }
    }
    ...
    fun getCheckAllowed() {
        if(name.isNotBlank() && nickName.isNotBlank() && checkPwdValid && checkUserNameValid && phoneNumValid) checkAllAllowed = true
    }
}